...
print(f'Название: {book_1.title}, Автор: {book_1.author}, страниц: {book_1.page_count}, '
      f'материал: {book_1.page_material}{", зарезервирована" if book_1.reservation else ""}')
print(f'Название: {book_2.title}, Автор: {book_2.author}, страниц: {book_2.page_count}, '
      f'материал: {book_2.page_material}{", зарезервирована" if book_2.reservation else ""}')
print(f'Название: {book_3.title}, Автор: {book_3.author}, страниц: {book_3.page_count}, '
      f'материал: {book_3.page_material}{", зарезервирована" if book_3.reservation else ""}')
print(f'Название: {book_4.title}, Автор: {book_4.author}, страниц: {book_4.page_count}, '
      f'материал: {book_4.page_material}{", зарезервирована" if book_4.reservation else ""}')
print(f'Название: {book_5.title}, Автор: {book_5.author}, страниц: {book_5.page_count}, '
